...
export async function updateProfileDetails({ name, roll, blood, phone, bio, session, year, hometown, address, socialLinks, gender, hidePhone, hideEmail, photoGuard, photoURL }) {
  ...
  const { profile } = await callApi("update-profile", {
    name, roll, blood, phone, bio, session, year, hometown, address, socialLinks, gender, hidePhone, hideEmail, photoGuard, photoURL
  });
  currentProfile = profile;
