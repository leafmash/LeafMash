...
const SOCIAL_LINK_ICONS = [
  { match: /facebook\.com|fb\.com/i, label: "Facebook", svg: `<svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor"><path d="M13.5 21v-7.9h2.65l.4-3.08h-3.05V8.05c0-.89.25-1.5 1.52-1.5h1.63V3.8A21.8 21.8 0 0 0 14.3 3.7c-2.44 0-4.11 1.49-4.11 4.22v2.1H7.5v3.08h2.69V21h3.31z"/></svg>` },
  { match: /instagram\.com/i, label: "Instagram", svg: `<svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.4" cy="6.6" r="1"/></svg>` },
  { match: /twitter\.com|x\.com/i, label: "X", svg: `<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M18.9 2.6h3.3l-7.2 8.2 8.5 11.2h-6.6l-5.2-6.8-6 6.8H2.4l7.7-8.8L1.9 2.6h6.8l4.7 6.2 5.5-6.2zm-1.2 17.4h1.8L7.3 4.4H5.4l12.3 15.6z"/></svg>` },
  ...
  { match: /youtube\.com|youtu\.be/i, label: "YouTube", svg: `<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M22 12s0-3.4-.44-5a3 3 0 0 0-2.1-2.1C17.9 4.5 12 4.5 12 4.5s-5.9 0-7.46.4A3 3 0 0 0 2.44 7C2 8.6 2 12 2 12s0 3.4.44 5a3 3 0 0 0 2.1 2.1c1.56.4 7.46.4 7.46.4s5.9 0 7.46-.4a3 3 0 0 0 2.1-2.1C22 15.4 22 12 22 12zM10 15.5v-7l6 3.5-6 3.5z"/></svg>` },
  { match: /github\.com/i, label: "GitHub", svg: `<svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor"><path d="M12 2a10 10 0 0 0-3.16 19.5c.5.1.68-.22.68-.48v-1.7c-2.78.6-3.37-1.34-3.37-1.34-.46-1.15-1.11-1.46-1.11-1.46-.9-.62.07-.6.07-.6 1 .07 1.53 1.03 1.53 1.03.9 1.53 2.34 1.09 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.56-1.11-4.56-4.94 0-1.09.39-1.98 1.03-2.68-.1-.25-.45-1.27.1-2.65 0 0 .84-.27 2.75 1.02a9.5 9.5 0 0 1 5 0c1.91-1.3 2.75-1.02 2.75-1.02.55 1.38.2 2.4.1 2.65.64.7 1.03 1.59 1.03 2.68 0 3.84-2.34 4.68-4.57 4.93.36.31.68.92.68 1.85v2.74c0 .27.18.58.69.48A10 10 0 0 0 12 2z"/></svg>` },
  { match: /wa\.me|whatsapp\.com/i, label: "WhatsApp", svg: `<svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor"><path d="M12 2a10 10 0 0 0-8.6 15.1L2 22l5.06-1.33A10 10 0 1 0 12 2zm0 18.2a8.13 8.13 0 0 1-4.15-1.14l-.3-.18-3.02.8.8-2.94-.19-.3A8.18 8.18 0 1 1 12 20.2zm4.48-6.13c-.24-.12-1.43-.7-1.65-.79-.22-.08-.38-.12-.55.12-.16.24-.63.79-.77.95-.14.16-.28.18-.52.06-.24-.12-1-.37-1.9-1.17-.7-.63-1.18-1.4-1.31-1.64-.14-.24-.02-.37.1-.49.11-.11.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.55-1.32-.75-1.8-.2-.48-.4-.42-.55-.42h-.47c-.16 0-.42.06-.64.3-.22.24-.85.83-.85 2.02s.87 2.35.99 2.51c.12.16 1.71 2.6 4.14 3.65.58.25 1.03.4 1.38.51.58.18 1.11.16 1.53.1.47-.07 1.43-.58 1.63-1.15.2-.56.2-1.04.14-1.15-.06-.1-.22-.16-.46-.28z"/></svg>` },
  { match: /t\.me|telegram\.me|telegram\.org/i, label: "Telegram", svg: `<svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor"><path d="M21.5 3.5 2.9 10.8c-1.2.5-1.2 1.2-.2 1.5l4.7 1.5 1.8 5.5c.2.6.4.9.9.9.4 0 .6-.2.9-.5l2.1-2 4.4 3.2c.8.5 1.4.2 1.6-.7l2.9-13.6c.3-1.2-.4-1.7-1.5-1.1zM8.3 13.4l9-5.6c.4-.3.8-.1.5.2l-7.5 6.8-.3 3-1.4-4.4z"/></svg>` },
  { match: /tiktok\.com/i, label: "TikTok", svg: `<svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor"><path d="M16.5 2h-3v13.6a2.6 2.6 0 1 1-2-2.53V9.9a5.9 5.9 0 1 0 5 5.83V9.1a7.9 7.9 0 0 0 4.5 1.4V7.3a4.9 4.9 0 0 1-4.5-4.4V2z"/></svg>` },
];
const SOCIAL_LINK_ICON_DEFAULT = { label: "Link", svg: `<svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.5.4l2-2a5 5 0 0 0-7-7l-1.2 1.1"/><path d="M14 11a5 5 0 0 0-7.5-.4l-2 2a5 5 0 0 0 7 7l1.1-1.1"/></svg>` };

export function socialLinkIconHtml(url) {
  const entry = SOCIAL_LINK_ICONS.find(({ match }) => match.test(url)) || SOCIAL_LINK_ICON_DEFAULT;
  return `<a class="profile-social-icon-btn" href="${escapeAttr(url)}" target="_blank" rel="noopener" aria-label="${entry.label} link">${entry.svg}</a>`;
}
